...
public class HCCoalBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hc_coal")
	public static final Block block = null;
	public HCCoalBlock(BpgCustomizationsModElements instance) {
		super(instance, 28);
	}
