...
public class HCEmeraldBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hc_emerald")
	public static final Block block = null;
	public HCEmeraldBlock(BpgCustomizationsModElements instance) {
		super(instance, 30);
	}
