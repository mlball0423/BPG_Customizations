...
public class HCGoldBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hc_gold")
	public static final Block block = null;
	public HCGoldBlock(BpgCustomizationsModElements instance) {
		super(instance, 19);
	}
