...
public class HCLapisBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hc_lapis")
	public static final Block block = null;
	public HCLapisBlock(BpgCustomizationsModElements instance) {
		super(instance, 29);
	}
