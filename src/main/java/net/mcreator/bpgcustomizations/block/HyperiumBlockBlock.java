...
public class HyperiumBlockBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hyperium_block")
	public static final Block block = null;
	public HyperiumBlockBlock(BpgCustomizationsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(4f, 10f).setLightLevel(s -> 5).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("hyperium_block");
		}
