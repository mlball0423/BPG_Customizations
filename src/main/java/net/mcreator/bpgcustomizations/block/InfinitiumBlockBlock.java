...
public class InfinitiumBlockBlock extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:infinitium_block")
	public static final Block block = null;
	public InfinitiumBlockBlock(BpgCustomizationsModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(5f, 3600000f).setLightLevel(s -> 15)
			...
			setRegistryName("infinitium_block");
		}
