...
public class ParadoxiumOreBlock extends BpgCustomizationsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 10f).setLightLevel(s -> 2).harvestLevel(10)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ParadoxiumCrystalItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("bpg_customizations:paradoxium_ore_match"),
			...
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("bpg_customizations:gnomia")))
			...
			event.getRegistry().register(feature.setRegistryName("paradoxium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bpg_customizations:paradoxium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
