...
public class GoblinTestEntity extends BpgCustomizationsModElements.ModElement {

	public static EntityType entity = null;

	public GoblinTestEntity(BpgCustomizationsModElements instance) {
		super(instance, 53);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f)).build("goblin_test")
						.setRegistryName("goblin_test");

		elements.entities.add(() -> entity);

		elements.items.add(() -> new SpawnEggItem(entity, -13408768, -10079488, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("goblin_test_spawn_egg"));
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcustom_model(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bpg_customizations:textures/goblin_texture.png");
					}
				};
			});
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.GOLDEN_CARROT, (int) (1)));
		}
