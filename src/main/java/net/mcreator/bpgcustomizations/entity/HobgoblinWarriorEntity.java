...
public class HobgoblinWarriorEntity extends BpgCustomizationsModElements.ModElement {
	public static EntityType entity = null;
	public HobgoblinWarriorEntity(BpgCustomizationsModElements instance) {
		super(instance, 58);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("hobgoblin_warrior").setRegistryName("hobgoblin_warrior");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10981048, -3757267, new Item.Properties().group(BPGCustomizationsTabItemGroup.tab))
				.setRegistryName("hobgoblin_warrior_spawn_egg"));
	}
