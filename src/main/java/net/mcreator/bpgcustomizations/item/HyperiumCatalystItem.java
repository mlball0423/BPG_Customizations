...
public class HyperiumCatalystItem extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hyperium_catalyst")
	public static final Item block = null;
	public HyperiumCatalystItem(BpgCustomizationsModElements instance) {
		super(instance, 61);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hyperium_catalyst");
		}
