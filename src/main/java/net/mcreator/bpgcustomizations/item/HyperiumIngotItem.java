...
public class HyperiumIngotItem extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hyperium_ingot")
	public static final Item block = null;
	public HyperiumIngotItem(BpgCustomizationsModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hyperium_ingot");
		}
