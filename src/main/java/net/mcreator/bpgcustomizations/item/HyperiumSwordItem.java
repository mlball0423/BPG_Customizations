...
public class HyperiumSwordItem extends BpgCustomizationsModElements.ModElement {
	@ObjectHolder("bpg_customizations:hyperium_sword")
	public static final Item block = null;
	public HyperiumSwordItem(BpgCustomizationsModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(BPGCustomizationsTabItemGroup.tab).isImmuneToFire()) {
		}.setRegistryName("hyperium_sword"));
	}
}
